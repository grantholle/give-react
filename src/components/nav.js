...
import { ReactComponent as Logo } from "../images/ldi-logo.svg"
...
class Nav extends React.Component {
  ...
  render () {
    return (
      <nav className={`header-nav white-nav`}>
          ...
          <div className="top-nav-wrapper">
            ...
            >
              <div className="w-8 h-6 flex flex-col justify-between">
                <div className={`h-1 rounded-full w-3/4 self-end bg-white`}></div>
                <div className={`h-1 rounded-full w-full bg-white`}></div>
                <div className={`h-1 rounded-full w-1/3 self-end bg-white`}></div>
              </div>
              <div className={`text-sm pl-2 text-white`}>MENU</div>
            </button>
