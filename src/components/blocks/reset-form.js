            ...
            <form action="/signin" method="post" onSubmit={this.handleSubmit}>
              ...
              <div className="py-4 text-center">
                ...
                <div className="text-sm my-4">
                  <span className="inline-block mr-2 text-gray-700">Know your password?</span> <a className="text-blue-500 underline" href="/signin">Sign in</a>
                </div>
                <div className="text-sm my-4">
                  <span className="inline-block mr-2 text-gray-700">No account?</span> <a className="text-blue-500 underline" href="/signup">Sign up</a>
                </div>
              </div>
            </form>
